...
def capture_plate(video):
    ...
    while True:
        ...
        if confidence>= 85:
            fcount =fcount+1
        if fcount == 2:
            cv2.imwrite("C:/Users/jayes/Desktop/arth/final task 8/IndianCarInfo_Fetcher-main/site/static/styles/carcont.jpeg",frames)
            s = 1
        if s==1:
            pytesseract.pytesseract.tesseract_cmd = r'D:\TESSERACT\tesseract.exe'
            img = cv2.imread('C:/Users/jayes/Desktop/arth/final task 8/IndianCarInfo_Fetcher-main/site/static/styles/carcont.jpeg',cv2.IMREAD_COLOR)
            ...
            if detected == 1:
                ...
                cv2.imwrite("C:/Users/jayes/Desktop/arth/final task 8/IndianCarInfo_Fetcher-main/site/static/styles/number.jpeg",Cropped)
...
def Car_info(text):
    ...
    username = "jatt.janvi" #insert your user name
...
def final():
        org, text , success =capture_plate('C:/Users/jayes/Desktop/arth/final task 8/IndianCarInfo_Fetcher-main/site/static/new.mp4')
        print(text)
